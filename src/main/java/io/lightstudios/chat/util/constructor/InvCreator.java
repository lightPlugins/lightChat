package io.lightstudios.chat.util.constructor;
...
import io.lightstudios.chat.util.handler.ActionHandler;
import io.lightstudios.chat.util.handler.ClickItemHandler;
...
public class InvCreator {
    ...
    public void openInventory() {
        ...
        bukkitTask = Bukkit.getScheduler().runTaskTimer(Light.instance, this::refreshGui, 0, refreshRate);
    ...
    private PatternPane getPatternPane() {
        ...
        for(String patternIdentifier : invConstructor.getClickItemHandlersSection().getKeys(false)) {
            ...
            patternPane.bindItem(patternIdentifier.charAt(0), new GuiItem(itemStack, inventoryClickEvent -> {
                ...
                Bukkit.getScheduler().runTaskLater(Light.instance, () -> {
    ...
    private void refreshGui() {
        ...
        gui.update();
        Light.getDebugPrinting().print("GUI refreshed");
    }
}