...
import io.lightstudios.chat.util.ColorTranslation;
import io.lightstudios.chat.util.DebugPrinting;
import io.lightstudios.chat.util.MessageSender;
import io.lightstudios.chat.util.SubPlaceholder;
import io.lightstudios.chat.util.database.SQLDatabase;
import io.lightstudios.chat.util.database.impl.MySQLDatabase;
import io.lightstudios.chat.util.database.impl.SQLiteDatabase;
import io.lightstudios.chat.util.database.model.ConnectionProperties;
import io.lightstudios.chat.util.database.model.DatabaseCredentials;
import io.lightstudios.chat.util.interfaces.LightModule;
import io.lightstudios.chat.util.manager.FileManager;
import io.lightstudios.chat.util.manager.InventoryManager;
import io.lightstudios.chat.util.manager.MultiFileManager;
import io.lightstudios.chat.util.manager.PlaceholderManager;
